...
## Se PosFIM for omitida, será exibido a partir da posição inicial até a última posição
cut -c5- numeros			// Exibe da 5º posição até a posição final
567890
654321
...
-s // Não mostra linhas sem delimitador
...
seq -s: 5 | cut -f3 -d:
3
root@whoami:~/teste-xargs# seq -s: 5 | cut -f3 -d: --complement
1:2:4:5
